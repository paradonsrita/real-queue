...
namespace ApiIsocare2.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        //  PUT: api/Employee/callBookingQueue
        [HttpPut("callBookingQueue")]
        public async Task<IActionResult> CallBookingQueue(int id, int counter)
        {
            try
            {
        ...
        //  PUT: api/Employee/skipBookingQueue
        [HttpPut("skipBookingQueue")]
        public async Task<IActionResult> SkipBookingQueue(int id, int counter)
        {
            try
            {
                var callQueue = await _db.BookingQueues
